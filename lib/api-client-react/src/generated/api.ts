 ...
 */
export const listPurchases = async (params?: ListPurchasesParams, options?: RequestInit): Promise<PurchasesPage> => {

  return customFetch<PurchasesPage>(getListPurchasesUrl(params),
  {
    ...options,
    method: 'GET'
